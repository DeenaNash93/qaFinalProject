...
public class MobileActions extends CommonOps {
    ...
    public static void pinch (MobileElement elem) {
        ...
        finger1.press(new ElementOption().withElement(elem).withCoordinates(x, y - 100)).moveTo(new ElementOption().withElement(elem).withCoordinates(x, y - 10));
    ...
    public static void zoom (MobileElement elem) {
        ...
        //Zoom
        TouchAction finger1 = new TouchAction(mobileDriver);
        finger1.press(new ElementOption().withElement(elem).withCoordinates(x, y - 10)).moveTo(new ElementOption().withElement(elem).withCoordinates(x, y - 100));
